...
let trackList = [
    {
        ...
        path: "./music/Ishq hai.mp3",
    },
    {
        name: "O Rangrez",
        artist: "Shankar Loy, Shreya Ghoshal",
        path: "./music/O Rangrez.mp3",
    },
    {
        name: "Dil se Dil tak",
        artist: "Akashdeep Sengupta",
        path: "./music/Dil Se Dil Tak.mp3",
    },
    {
        name: "Oonchi Deewarein",
        artist: "Manan Bhardwaj, Arijit Singh",
        path: "./music/Oonchi Oonchi Deewarein.mp3",
    },
];
